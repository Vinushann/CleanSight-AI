        ...
        rows.append(
            {
                ...
                "dust_voltage": _to_float(payload.get("dust_voltage")),
                "dust_raw_adc": _to_int(payload.get("dust_raw_adc"), default=0) if payload.get("dust_raw_adc") is not None else None,
                ...
                "cleanliness_score": _to_float(payload.get("cleanliness_score")),
                "cleanliness_status": payload.get("cleanliness_status"),
                "anomaly_status": payload.get("anomaly_status"),
                "cleaning_urgency": payload.get("cleaning_urgency"),
                "predicted_next_cleanliness": _to_float(payload.get("predicted_next_cleanliness")),
                "actual_cleanliness": _to_float(payload.get("actual_cleanliness")),
                "trend_direction": payload.get("trend_direction"),
                "cleanliness_prediction": payload.get("cleanliness_prediction"),
                "anomaly_prediction": payload.get("anomaly_prediction"),
                "next_dust_prediction": _to_float(payload.get("next_dust_prediction")),
                "prediction_reason": payload.get("prediction_reason"),
