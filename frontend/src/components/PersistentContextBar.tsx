...
export default function PersistentContextBar({
  ...
  return (
    <section className="cs-card sticky top-0 z-10" style={{ paddingTop: '0.85rem', paddingBottom: '0.85rem' }}>
      <div className="flex flex-wrap items-center gap-2">
        ...
        {activeStage && activeStage !== 'all' ? <Pill label="Linked Stage" value={activeStage} /> : null}
