...
const pageTitles: Record<string, string> = {
  ...
  '/modules/iot/realtime': 'IoT Data Collection Control',
  '/modules/iot/ml-prediction': 'IoT Data Collection Control',
  '/modules/iot/device-health': 'IoT Data Collection Control',
  '/modules/iot/settings': 'IoT Data Collection Control',
  '/modules/iot/help': 'IoT Data Collection Control',
...
export default function Topbar() {
  ...
  const hideTopbar = pathname.startsWith('/modules/iot');
